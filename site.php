...
$app->post("/checkout", function(){
    ...
    $totals = $cart->getCalculateTotal(1);
...
$app->get("/boleto/:idorder", function($idorder){
    ...
    // NÃO ALTERAR!
    $path = $_SERVER["DOCUMENT_ROOT"]. DIRECTORY_SEPARATOR. "res". DIRECTORY_SEPARATOR. "boletophp". DIRECTORY_SEPARATOR. "include".
    DIRECTORY_SEPARATOR;
...
$app->post("/profile/change-password", function(){
    ...
    if($_POST["new_pass"] !== $_POST["new_pass_confirm"]){
        ...
        User::setError("Senhas diferentes digitadas na confirmação");
        header("Location: /profile/change-password");
        exit;
